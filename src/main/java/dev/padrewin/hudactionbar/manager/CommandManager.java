package dev.padrewin.hudactionbar.manager;
...
import dev.padrewin.hudactionbar.commands.Commander;
...
public class CommandManager extends Manager {
    ...
    public void reload() {
        ...
        // Register commands
        Commander commander = new Commander((HudActionbar) this.coldPlugin);
        PluginCommand command = this.coldPlugin.getCommand("hudactionbar");
        if (command != null)

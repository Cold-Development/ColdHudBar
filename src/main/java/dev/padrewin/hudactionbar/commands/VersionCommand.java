...
public class VersionCommand extends BaseCommand {
    ...
    public static void sendInfo(HudActionbar plugin, CommandSender sender) {
        ...
        localeManager.sendCustomMessage(sender, baseColor + "Running <g:#635AA7:#E6D4F8:#9E48F6>hudactionbar" + baseColor + " v" + plugin.getDescription().getVersion());
        ...
        if (sender instanceof Player) {
            ...
            clickableText.setClickEvent(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://github.com/Cold-Development/HudActionbar"));
            ...
            sender.sendMessage(ansiAqua + "GitHub: " + ansiRed + "https://github.com/Cold-Development/HudActionbar" + ansiReset);
        }
